...
namespace massive_moose.services
{
    public class Auth
    {
        ...
        public static bool VerifyPassword(string guess, string actual)
        {
            ...
            var actualSavedHashResultsBtyeArr = Convert.FromBase64String(actual);
            ...
            var passwordGuessByteArr = GenerateHashValue(guess, salt, BitConverter.ToInt32(iterationCountByteArr, 0));
